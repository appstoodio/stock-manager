...
//  String imei =
//         Get.arguments != null && Get.arguments is String
//             ? Get.arguments
//             : [];
...
//     String company = arguments?['company'] ?? '';
                  ...
                  onPressed: () async {
                   ...
                   String? user = FirebaseAuth.instance.currentUser?.uid;
                    ...
                    try {
                      ...
                      QuerySnapshot<Object?> querySnapshot = await transactionCollection
    .where('transactionType', isEqualTo: 'In').
    where('imei',isEqualTo: stockOutController.imeiController.text).where('user',isEqualTo: user)
  .limit(1)
    .get();
  ...
  if (querySnapshot.docs.isNotEmpty) {
    ...
    String company = querySnapshot.docs[0]['company'] as String;
    ...
    Get.snackbar('Error', 'StockIn for that not found');
                      ...
                      // if (stockOutController
                      //     .vendorNameController.text.isNotEmpty) {
                      //   stockOutController.uplaodDuePayment(formattedDate,
                      //       stockOutController.imeiController.text);
                      // }
                      // Call the uploadStock method with the retrieved model and company
