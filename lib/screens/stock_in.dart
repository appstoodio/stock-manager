            ...
            children: [
                                          ...
                                          children: [
                                            Padding(
                                                ...
                                                child: (Row(
                                                  children: [
                                                    TextButton(
                                                        onPressed: () {stockInController.deleteCompany(comp.id.toString(), context);},
              ...
              Container(
                ...
                child: TextButton(
                    onPressed: () {
                      final imeiii =
                          int.parse(stockInController.imeiController.text);
                      ...
                      if (stockInController.modelController.text.isNotEmpty &&
                          stockInController.priceController.text.isNotEmpty &&
                          stockInController.imeiController.text.isNotEmpty &&
                          selectedValue != null) {
                        stockInController.uploadStock(
                            selectedValue.toString().split('_')[0],
                            formattedDate,
                            imeiii,
                            context);
                      } else {
